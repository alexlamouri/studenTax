...
class View():
    ...
    def init_calculate_return_view(self, root):
        ...
        action_frame = tk.Frame(view)
        tk.Button(action_frame, text = "view my tax documents").grid(row = 0, column = 0, columnspan=4)
        tk.Button(action_frame, text = "export to csv").grid(row=0, column = 4, columnspan=4)
